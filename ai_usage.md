...
- Reviewing statistical explanations against course material.
- Discarding any AI-generated content that did not align with the actual Python results.
...
No sensitive or identifiable patient information was used. The TARGET-ALL Phase II dataset is public and fully de-identified through cBioPortal, so no protected clinical data were shared with AI tools. AI usage was limited to debugging, formatting, and organizational assistance. All AI contributions were reviewed and documented to ensure transparency, accuracy, and responsible use.
